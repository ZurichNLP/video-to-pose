...
#SBATCH --job-name=vitpose_semlex_        ## Job name
#SBATCH --output=vitpose_semlex__%j.out   ## Output file (%j = job ID)
#SBATCH --error=vitpose_semlex__%j.err    ## Error file (%j = job ID)
