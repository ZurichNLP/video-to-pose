...
#SBATCH --job-name=citizen_vitpose        ## Job name
#SBATCH --output=citizen_vitpose_%j.out   ## Output file (%j = job ID)
#SBATCH --error=citizen_vitpose_%j.err    ## Error file (%j = job ID)
