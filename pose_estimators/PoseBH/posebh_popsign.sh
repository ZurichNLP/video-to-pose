...
#SBATCH --job-name=posebh_popsign        ## Job name
#SBATCH --output=posebh_popsign_%j.out   ## Output file (%j = job ID)
#SBATCH --error=posebh_popsign_%j.err    ## Error file (%j = job ID)
...
python video_inference_wholebody_mp.py \
    --input_dir /shares/iict-sp2.ebling.cl.uzh/common/popsign_v1_0/game \
    --output_dir /shares/iict-sp2.ebling.cl.uzh/common/popsign_v1_0/posebh \
