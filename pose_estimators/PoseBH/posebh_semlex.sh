...
#SBATCH --job-name=posebh_semlex        ## Job name
#SBATCH --output=posebh_semlex_%j.out   ## Output file (%j = job ID)
#SBATCH --error=posebh_semlex_%j.err    ## Error file (%j = job ID)
...
python video_inference_wholebody_mp.py \
    --input_dir /shares/iict-sp2.ebling.cl.uzh/common/Sem-Lex/video \
    --output_dir /shares/iict-sp2.ebling.cl.uzh/common/Sem-Lex/posebh \
