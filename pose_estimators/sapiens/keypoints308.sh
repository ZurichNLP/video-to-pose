#!/bin/bash
cd /home/gsantm/repositories/sapiens/pose/scripts/demo/local
cd ../../.. || exit
SAPIENS_ROOT=/home/gsantm/repositories/sapiens
#SAPIENS_CHECKPOINT_ROOT=/home/${USER}/sapiens_host
SAPIENS_CHECKPOINT_ROOT=/home/gsantm/store/pose_estimators/sapiens
...
INPUT='/home/gsantm/scripts/pose_estimators/sapiens/sapiens_frames'

#OUTPUT="/home/${USER}/Desktop/sapiens/pose/Outputs/vis/itw_videos/reel2"

OUTPUT="/home/gsantm/scripts/pose_estimators/sapiens/sapiens_output"


#--------------------------MODEL CARD---------------
# MODEL_NAME='sapiens_0.3b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_0.3b/sapiens_0.3b_goliath_best_goliath_AP_573.pth
# MODEL_NAME='sapiens_0.6b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_0.6b/sapiens_0.6b_goliath_best_goliath_AP_609.pth
MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/pose/checkpoints/sapiens_1b/sapiens_1b_goliath_best_goliath_AP_639.pth
CHECKPOINT='/home/gsantm/store/pose_estimators/sapiens/sapiens_1b_goliath_best_goliath_AP_639.pth'

DATASET='goliath'
MODEL="${MODEL_NAME}-210e_${DATASET}-1024x768"
#CONFIG_FILE="configs/sapiens_pose/${DATASET}/${MODEL}.py"
CONFIG_FILE="/home/gsantm/repositories/sapiens/pose/configs/sapiens_pose/${DATASET}/${MODEL}.py"
...
#DETECTION_CHECKPOINT=/home/gsantm/store/pose_estimators/sapiens/rtmdet_m_8xb32-100e_coco-obj365-person-235e8209.pth
